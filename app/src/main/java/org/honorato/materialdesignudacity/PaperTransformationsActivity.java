...
public class PaperTransformationsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_paper_transformations);
        ...
        rv.setAdapter(new RecyclerView.Adapter<ViewHolder>() {
            ...
            public ViewHolder onCreateViewHolder(ViewGroup parent, int position) {
                return new ViewHolder(getLayoutInflater().inflate(R.layout.paper_list_item, parent, false));
            }
    ...
    private static class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public ViewHolder(View itemView) {
            ...
            if (green == 0)
                green = ContextCompat.getColor(itemView.getContext(), R.color.green);
            if (white == 0)
                white = ContextCompat.getColor(itemView.getContext(), R.color.background_material_light);
        }
        ...
        public void onClick(View view) {
            ...
            if (isVeggie) {
                ...
                textColor = ContextCompat.getColor(view.getContext(), android.R.color.black);
